                ...
                <div class="pb-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="note" name="note" rows="3" class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter note here"><?= $_POST['note'] ?? '' ?></textarea>
                            </div>
                            <p class="mt-3 text-sm leading-6 text-red-600">
                                <?= isset($error['body']) ?  $error['body'] : ''; ?>
                            </p>
                        </div>
